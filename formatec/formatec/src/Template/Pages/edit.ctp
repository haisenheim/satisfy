...
<div class="well">
    ...
    <form method="post" enctype="multipart/form-data" action="<?= $this->Url->build(['controller'=>'Pages','action'=>'edit', $page->id]) ?>">
        ...
        <textarea name="body" id="corps" cols="30"  rows="10" value="<?= $page->body ?>"></textarea>
        <hr/>
        <input type="file" name="image1" class="form-control" id="image1" value="<?= $page->image1 ?>"/>
        <hr/>
